  ...
  return (
    <footer className="bg-gray-200 rounded-t-3xl border-t-1">
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        <Image src={Logo} alt="#" className="mx-auto h-14 w-auto" />
        ...
        <ul className="mt-12 flex flex-wrap justify-center gap-6 md:gap-8 lg:gap-12">
          <li>
            <h1 className="text-primary transition hover:text-primary/75">
              ©️ {new Date(Date.now()).getFullYear()} {appConfig.appName}
            </h1>
          </li>
        </ul>
